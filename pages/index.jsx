    ...
    <>
      ...
      <footer className='text-sm py-8 px-4 bg-gray-900 text-white grid grid-cols-1 md:grid-cols-2' >
        <ul className='mx-auto my-4' >
          <li style={{ lineBreak: "none" }} >✔️ About us</li>
          <li style={{ lineBreak: "none" }} >✔️ Galley</li>
          <li style={{ lineBreak: "none" }} >✔️ our office</li>
        ...
        <div className='mx-auto my-8 md:my-0' >
          ...
          <div className={styles.borderleft} >
            <span className='cursor-pointer' >
              <Link href="https://www.facebook.com/profile.php?id=100083055919121" >
                <div className='flex' >
