    ...
    <>
      ...
      <main className="mb-2">
        ...
        <div id='about' className="my-8">
          ...
          <p className={`${styles.smallText} ${styles.centercontents}`} ><b>Silla sofa seat</b> ni wataalam wa kutengeneza masofa ya aina mbalimbali. Tunatengeneza masofa ya designs mbalimbali na tunakufikishia mahali popote ulipo.</p>
        </div>
        ...
        <div id='services' className={`${styles.centercontents} my-8`} >
          ...
          <div id='contacts' className="my-8">
            ...
            <ul >
              <li>
                <a className=' font-bold mt-2 flex items-center' href="tel:+255735042895">
              ...
              <li>
                <a className=' font-bold mt-2 flex items-center' href={`https://wa.me/255735042895?text=hello%20silla%20sofa%20seat%20how%20are%20you`}>
          ...
          <div className="my-8">
            <div className={styles.client}>
              <div className={styles.imageWrapper}>
                <img className='w-full h-full' src="/images/image2.png" alt="client" />
              </div>
              <p className={styles.clientText} >Hello i am amos, from mbeya green city. silla sofa seat are so good on what they do. I like their works</p>
            </div>
          </div>
          <div className="my-8">
            <div className={styles.client}>
